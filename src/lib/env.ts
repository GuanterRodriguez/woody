...
export const ENV = {
  n8n: {
    ...
    apiUrl: (import.meta.env.VITE_N8N_API_URL as string) ?? "",
    apiKey: (import.meta.env.VITE_N8N_API_KEY as string) ?? "",
    timeoutMinutes: Number(import.meta.env.VITE_N8N_TIMEOUT_MINUTES || "10"),
  },
  fabric: {
