...
import { Eye, Scissors, Trash2, Zap } from "lucide-react";
...
export function ImportDocumentsPage() {
  ...
  const { markImportPageSeen } = useNavigationStore();
    ...
    <div className="h-full overflow-auto p-6 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              Classifiez vos documents (CDV ou Fiche de lot) pour pouvoir créer
              des dossiers.
            </p>
      ...
      >
        <DialogContent className="flex h-[90vh] w-[calc(100vw-2rem)] max-w-none sm:max-w-none flex-col">
          <DialogHeader>
            <DialogTitle>Decouper : {activeDocument?.fileName}</DialogTitle>
          </DialogHeader>
          {activeDocument && (
            <PdfSplitter
              filePath={activeDocument.filePath}
